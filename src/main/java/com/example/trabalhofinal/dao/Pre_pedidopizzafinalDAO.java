...
import com.example.trabalhofinal.inter.ipre_pedidopizzafinalDAO;
...
public class Pre_pedidopizzafinalDAO implements ipre_pedidopizzafinalDAO {
    ...
    public pre_pedidopizzafinal create(pre_pedidopizzafinal pre_pedidopizzafinal) {
        try(Connection connection = connectionFactory.getConnection()){
            ...
            statement.setFloat(3, pre_pedidopizzafinal.getValortotalp());
    ...
    public List<pre_pedidopizzafinal> findall() {
        ...
        try(Connection connection = connectionFactory.getConnection()) {
            ...
            while (rs.next()){
                ...
                pre_pedidopizzafinal.setValortotalp(rs.getFloat("valortotalp"));
